...
- Orders data (SQL Server): Server=.;Database=Microsoft.eShopOnContainers.Services.OrderingDb;
- Catalog data (SQL Server): Server=.;Database=CatalogDB;
- Identity data (SQL Server): Server=.;Database=aspnet-Microsoft.eShopOnContainers;
